...
// This is your quaternion which you will use for rotational transformations.
glm::quat quaternion;

// This one will store a 1 degree rotation to be added every frame.
glm::quat baseRotate;
...
void update()
{
	// Multiplying quaternions is like adding their rotations together. The baseRotate is a quaternion representing a 1 degree rotation over the X-Y axis.
	// Quaternion is then every frame getting that 1 degree rotation added to itself, then converting to a transformation matrix to be sent to the shader.
...
int main(int argc, char **argv)
{
	...
	GLFWwindow* window = glfwCreateWindow(800, 600, "Quaternions", nullptr, nullptr);
